...
namespace Matrix42.Client.Mail
{
    public class MailAddress
    {
	    ...
	    public static MailAddress From(EmailAddress address)
	    {
	    ...
	    public static IList<MailAddress> ListFrom(EmailAddressCollection addresses)
	    {
		    return addresses?.Select(From).ToArray();
	    }
