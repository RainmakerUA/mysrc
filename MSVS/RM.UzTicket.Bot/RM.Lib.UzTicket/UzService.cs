...
namespace RM.Lib.UzTicket
{
	...
	{
		private const string _proxyUrl = "";// "http://31.134.106.66:31697/";
		...
		public UzService(string baseUrl = null, string sessionIdKey = null, ILog logger = null)
		{
		...
		*/
		...
		private void InitializeHttpClient()
		{
			...
			{
				_httpHandler.Proxy = new WebProxy(new Uri(_proxyUrl));
			}
		}
